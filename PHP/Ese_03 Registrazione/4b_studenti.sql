...
--
-- Host: 127.0.0.1
-- Creato il: Apr 24, 2021 alle 13:07
...
INSERT INTO `studenti` (`id`, `nome`, `settore`, `hobbies`, `residenza`, `note`, `media`) VALUES
(1, 'Paolo', 'Informatica', 'Musica,Sport', 1, 'Nessuno', '1,3'),
(2, 'Pippo', 'Informatica', 'Sport,Musica', 2, 'Nessuno', '1,2');
