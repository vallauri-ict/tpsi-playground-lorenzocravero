...
$(document).ready(function () {
    let modelloSelezionato; //variabile globale che conterrà il modello da visualizzare
    ...
    _lstModelli.on("change",function(){
        _table.empty();
        //val di un listbox contiene sempre il val della voce selezionata
        modelloSelezionato=_lstModelli.val(); //salvo dentro la variabile l'id del modello selezionato
    ...
    function dettagliClick(){
        ...
        let url=URL + "/modelli/"+modelloSelezionato; //richiesta per le informazioni di quel modello
